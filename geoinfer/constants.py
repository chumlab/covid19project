...
ALT_COUNTRY_NAMES = {
    # United States
    6252001: ['USA', 'US', 'United States of America', 'America', 'Estados Unidos', '🇺🇸'],
    ...
    # Dominiucal Republic
    3508796: ['República Dominicana', 'Republica Dominicana'],
    3932488: ['Perú', '🇵🇪'],  # Peru
    1269750: ['भारत', '🇮🇳'],  # India
    ...
    # Saudi Arabia
    2287781: ['Kingdom of Saudi Arabia', 'ٱلْمَمْلَكَة ٱلْعَرَبِيَّة ٱلسَّعُوْدِيَّة'],
